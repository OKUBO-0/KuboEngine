...
void GameplayRuntimeDebugPanel::DrawObjectManager(
	bool* open,
...
void GameplayRuntimeDebugPanel::DrawMotionEditor(bool* open)
{
#ifdef _DEBUG
	if (!open || !*open) {
		return;
...
void GameplayRuntimeDebugPanel::DrawColliderManager(
	bool* open,
