...
std::vector<std::string> BuildRequiredAssetPaths()
{
	...
	paths = {
		...
		ResourcePaths::MakeAudioPath("bgm/title_loop.wav"),
		ResourcePaths::MakeAudioPath("bgm/game_loop.wav"),
		ResourcePaths::MakeAudioPath("bgm/boss_loop.wav"),
		ResourcePaths::MakeAudioPath("se/ui_select.wav"),
		ResourcePaths::MakeAudioPath("se/ui_decide.wav"),
		ResourcePaths::MakeAudioPath("se/ui_back.wav"),
		ResourcePaths::MakeAudioPath("se/game_start.wav"),
		ResourcePaths::MakeAudioPath("se/pause_toggle.wav"),
		ResourcePaths::MakeAudioPath("se/level_up.wav"),
		ResourcePaths::MakeAudioPath("se/game_over.wav"),
		ResourcePaths::MakeAudioPath("se/player_dodge.wav"),
		ResourcePaths::MakeAudioPath("se/shot.wav"),
		ResourcePaths::MakeAudioPath("se/enemy_hit.wav"),
		ResourcePaths::MakeAudioPath("se/enemy_death.wav"),
		ResourcePaths::MakeAudioPath("se/player_damage.wav"),
		ResourcePaths::MakeAudioPath("se/exp_pickup.wav"),
		ResourcePaths::MakeAudioPath("se/coin_gain.wav"),
		ResourcePaths::MakeAudioPath("se/result_finish.wav"),
		ResourcePaths::MakeAudioPath("se/boss_phase.wav"),
		ResourcePaths::MakeAudioPath("se/boss_rush.wav"),
		ResourcePaths::MakeAudioPath("se/boss_slam.wav"),
		ResourcePaths::MakeAudioPath("se/boss_ink.wav"),
		ResourcePaths::MakeAudioPath("se/boss_defeat.wav"),
		ResourcePaths::MakeAudioPath("se/weapon_lightning.wav"),
		ResourcePaths::MakeAudioPath("se/weapon_sword.wav"),
		ResourcePaths::MakeAudioPath("se/weapon_aura.wav"),
		ResourcePaths::MakeAudioPath("se/weapon_flame.wav"),
