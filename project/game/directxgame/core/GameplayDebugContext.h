...
#include "game/directxgame/core/GameplayStatisticsDebugPanel.h"
...
class GameplayDebugContext final {
public:
	...
	GameplayDebugWindowVisibility& Windows() { return windows_; }
	const GameplayDebugWindowVisibility& Windows() const { return windows_; }
	GameplayStatisticsDebugPanel& StatisticsPanel() {
...
private:
	...
	GameplayDebugWindowVisibility windows_{};
	GameplayStatisticsDebugPanel statisticsPanel_{};
