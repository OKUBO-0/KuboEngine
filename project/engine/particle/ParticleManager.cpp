...
void ParticleManager::Initialize(Engine::Base::DirectXCommon* dxcommn, Engine::Base::SrvManager* srvmaneger)
{
...
{
	Matrix4x4 viewMatrix = Engine::CameraSystem::CameraManager::GetInstance()->GetActiveCamera()->GetViewMatrix();
	Matrix4x4 projectionMatrix = Engine::CameraSystem::CameraManager::GetInstance()->GetActiveCamera()->GetProjectionMatrix();
