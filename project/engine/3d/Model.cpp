...
void Model::Draw()
{
	...
	// テクスチャSRV設定
	modelCommon_->GetSRVManager()->SetGraficsRootDescriptorTable(2, Engine::Base::TextureManager::GetInstance()->GetTextureIndexByFilePath(modelData.material.textureFilePath));
...
ModelData Model::LoadModelFile(const std::string& directoryPath, const std::string& filename)
{
    ...
    std::string path = directoryPath + "/" + "models" + "/" + filename;
