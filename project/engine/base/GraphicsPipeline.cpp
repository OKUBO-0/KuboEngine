...
void GraphicsPipeline::Create()
{
	...
	auto [vertexshaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/Object3D.VS.hlsl", L"Resources/Shaders/Object3D.PS.hlsl");
...
void GraphicsPipeline::CreateParticle()
{
	...
	auto [vertexshaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/Particle.VS.hlsl", L"Resources/Shaders/Particle.PS.hlsl");
...
void GraphicsPipeline::CreateSprite()
{
	...
	auto [vertexshaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/Sprite.VS.hlsl", L"Resources/Shaders/Sprite.PS.hlsl");
...
void GraphicsPipeline::CreateSkinning()
{
	...
	D3D12_RASTERIZER_DESC rasterizerDesc = CreateSolidRasterizerDesc();
	auto [vertexshaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/SkinningObject3d.VS.hlsl", L"Resources/Shaders/SkinningObject3d.PS.hlsl");
	D3D12_DEPTH_STENCIL_DESC depthStencilDesc = CreateDepthStencilDesc(D3D12_DEPTH_WRITE_MASK_ALL);
...
void GraphicsPipeline::CreateLine()
{
	...
	D3D12_DEPTH_STENCIL_DESC depthStencilDesc = CreateDepthStencilDesc(D3D12_DEPTH_WRITE_MASK_ALL);
	auto [vertexShaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/Line.VS.hlsl", L"Resources/Shaders/Line.PS.hlsl");
...
void GraphicsPipeline::CreateCopyImage(PostEffectType type, const std::wstring& psFilename)
{
	...
	auto [vertexShaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/Fullscreen.VS.hlsl", psFilename.c_str());
...
void GraphicsPipeline::CreateSkybox()
{
	...
	D3D12_RASTERIZER_DESC rasterizerDesc = CreateSolidRasterizerDesc();
	auto [vertexshaderBlob, pixelShaderBlob] = CompileShaderPair(
		dxCommon_, L"Resources/Shaders/Skybox.VS.hlsl", L"Resources/Shaders/Skybox.PS.hlsl");
	D3D12_DEPTH_STENCIL_DESC depthStencilDesc = CreateDepthStencilDesc(D3D12_DEPTH_WRITE_MASK_ZERO);
